...
export class DbManager {
    ...
    createDb(connection=this.db_connection, dbname=this.db_name): Promise<any>{
    ...
    createTablePurchases(connection=this.db_connection): Promise<any>{
        return new Promise((resolve, reject) => {
    ...
    createTableLinks(connection=this.db_connection): Promise<any>{
        return new Promise((resolve, reject) => {
    ...
    insert(entity:any, connection=this.db_connection): Promise<any>{
        return new Promise((resolve, reject) => {
    ...
    remove(e_id:number, connection=this.db_connection): Promise<any>{
        return new Promise((resolve, reject) => {
    ...
    update(update_row:string, where_condition:string ,connection=this.db_connection): Promise<any>{
        return new Promise((resolve, reject) => {
    ...
    openConnection(connection=this.db_connection): Promise<any>{
        return new Promise((resolve, reject) => {
            connection.connect(function(e:Error) {
                if (e) throw e;
            });
    ...
    closeConnection(connection=this.db_connection): Promise<any> {
        return new Promise((resolve, reject) => {
    ...
    queryDb(query: string, connection = this.db_connection): Promise<any> {
        return new Promise((resolve, reject) => {
